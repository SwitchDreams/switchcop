...
Gem::Specification.new do |spec|
  ...
  spec.description = "Gem containing the rubocop.yml config that corresponds to the implementation of the Switch Dreams` style guide for Ruby."
  ...
  spec.metadata["changelog_uri"] = "https://github.com/SwitchDreams/switchcop"
